...
<form id="form1" runat="server" onclick="open(DropDownListMajor)">
	<asp:DropDownList id="DropDownListMajor" runat="server" DataSourceID="SqlDataSource1" DataTextField="course_number" DataValueField="course_number" AutoPostBack="True">
	</asp:DropDownList>
...
<p>Marketing Minor.</p>
	<asp:DropDownList id="DropDownList1" runat="server" DataSourceID="SqlDataSource2" DataTextField="course_number" DataValueField="course_number" AutoPostBack="True">
	</asp:DropDownList>
...
<p>Politics Minor.</p>
	<asp:DropDownList id="DropDownList2" runat="server" DataSourceID="SqlDataSource3" DataTextField="course_number" DataValueField="course_number" AutoPostBack="True">
	</asp:DropDownList>
