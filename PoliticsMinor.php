...
$mmfallquery= 'SELECT course_number FROM politics_minor WHERE Fall_2016 = "Yes" ';
...
$mmfallquery= 'SELECT course_number FROM politics_minor WHERE Spring_2017 = "Yes" ';
$mmresultfall= mysql_query($mmfallquery) or die ("Query to get data from firsttable failed: ".mysql_error());
echo "<select name = cismfall>";
while ($mmfallrow=mysql_fetch_array($mmresultfall)){
    $mmTitlefall = $mmfallrow["course_number"];
...
$mmfallquery= 'SELECT course_number FROM politics_minor WHERE Requirement = "Y" ';
$mmresultfall= mysql_query($mmfallquery) or die ("Query to get data from firsttable failed: ".mysql_error());
echo "<select name = cismfall>";
...
$mmfallquery= 'SELECT course_number FROM politics_minor WHERE elective = "Y" ';
$mmresultfall= mysql_query($mmfallquery) or die ("Query to get data from firsttable failed: ".mysql_error());
echo "<select name = cismfall>";
while ($mmfallrow=mysql_fetch_array($mmresultfall)){
    $mmTitlefall = $mmfallrow["course_number"];
...
function getResult(){
    $sqlform = "SELECT * FROM politics_minor WHERE course_number LIKE '". $_POST['politicsm']."'";
