...
$mmfallquery= 'SELECT course_number FROM idcc_minor WHERE Fall_2016 = "Yes" ';
...
$mmfallquery= 'SELECT course_number FROM idcc_minor WHERE Spring_2017 = "Yes" ';
$mmresultfall= mysql_query($mmfallquery) or die ("Query to get data from firsttable failed: ".mysql_error());
echo "<select name = cismfall>";
while ($mmfallrow=mysql_fetch_array($mmresultfall)){
    $mmTitlefall = $mmfallrow["course_number"];
...
$mmfallquery= 'SELECT course_number FROM IDCC_minor WHERE Requirement = "Y" ';
$mmresultfall= mysql_query($mmfallquery) or die ("Query to get data from firsttable failed: ".mysql_error());
echo "<select name = cismfall>";
if (mysql_num_rows($mmresultfall)== 0)
    {
        echo "<option> No Required Courses </option>";
    }
while ($mmfallrow=mysql_fetch_array($mmresultfall)){
    $mmTitlefall = $mmfallrow["course_number"];
    echo "<option>
...
$mmfallquery= 'SELECT course_number FROM IDCC_minor WHERE elective = "Y" ';
$mmresultfall= mysql_query($mmfallquery) or die ("Query to get data from firsttable failed: ".mysql_error());
echo "<select name = cismfall>";
while ($mmfallrow=mysql_fetch_array($mmresultfall)){
    $mmTitlefall = $mmfallrow["course_number"];
...
function getResult(){
    //$sqlform = "SELECT * FROM idcc_major WHERE course_number LIKE '". $_POST['idccm']."'";
    $sqlform = "SELECT * FROM idcc_minor WHERE course_number LIKE '". $_POST['idccm']."'";
